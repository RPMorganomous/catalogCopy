...
def restaurantMenuJSON(restaurant_id): # check PASS
    return "This page will show an entire menu as a JSON"
...
def restaurantsJSON(): # check PASS
    return "This page will show all my restaurants in JSON"
    # restaurants = session.query(Restaurant).all()
    # return jsonify(restaurants=[r.serialize for r in restaurants])

@app.route('/restaurant/<int:restaurant_id>/menu/<int:menu_id>/JSON/')
def menuItemJSON(restaurant_id, menu_id): # check PASS
    return "This page will show a menu item as a JSON"
